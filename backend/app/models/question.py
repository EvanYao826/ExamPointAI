from sqlalchemy import Column, BigInteger, String, Text, TinyInteger, DateTime
...
class Question(Base):
    ...
    difficulty = Column(TinyInteger, default=1, comment="难度等级")
...
class QuestionOption(Base):
    ...
    is_answer = Column(TinyInteger, default=0, comment="是否正确答案")
...
class UserAnswerRecord(Base):
    ...
    is_correct = Column(TinyInteger, default=0, comment="是否正确")
